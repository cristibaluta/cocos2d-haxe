...
@property (nonatomic, assign) Float pointSize __AVAILABILITY_INTERNAL_DEPRECATED;
...
- (id)initWithFrame:(CGRect)frame font:(CGFontRef)font pointSize:(Float)pointSize __AVAILABILITY_INTERNAL_DEPRECATED;
@end
