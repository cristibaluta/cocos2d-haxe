...
class CCParticleGalaxy extends ARCH_OPTIMAL_PARTICLE_SYSTEM
{
//
public function init () :CCParticleGalaxy
{
	return this.initWithTotalParticles ( 200 );
}

override public function initWithTotalParticles (p:Int) :CCParticleGalaxy
{
